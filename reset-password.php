...
include("con.php");
 ...
 {
 $otp=$_SESSION["OTP"];
 if(isset($_POST['VERYFIY'])&& isset($_POST['EnterOtp']))
 {
 if($otp==trim($_POST['EnterOtp'])){
              ...
              <div class="">
                ...
                >
                  <div class="form-group">
                    <input
                      class="form-control"
                      type="text" style="width:200px;margin:auto" name="EnterOtp" id="EnterOtp"
                      placeholder="Enter OTP"
                    />
                  </div>
                  <div class="form-group">
                    <button  style="width:200px;margin:auto"  class="btn btn-primary btn-block" name="VERYFIY" type="submit">
                      Verify OTP
                    </button>
                  </div>
                </form>             
...
function loginValidate(){
	if(document.getElementById("EnterOtp").value==''){
